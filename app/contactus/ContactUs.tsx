...
const ContactUs = () => {
	...
	return (
		<>
			<Head>
				<title>GreenRecycle - Connect With Our Sustainability Experts</title>
				<meta
					name="description"
					content="Have questions about e-waste management or our platform? Get in touch with GreenRecycle's dedicated team for personalized assistance and information."
				/>
			</Head>
								...
								<li className="footer-item flex items-start">
									...
									<div>
										...
										<address className="contact-link address text-gray-600">
											Main Office: Alpha 1, Greater Noida
											<br />
											Uttar Pradesh, India 431001
										</address>
									</div>
								</li>
								<li className="footer-item flex items-start">
