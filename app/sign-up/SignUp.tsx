	...
	return (
		<>
			<div className="my-3 text-center">
				<span className="text-4xl font-bold ">Welcome to GreenRecycle</span>
				...
				<div className="relative flex flex-col p-6 bg-white shadow-2xl md:flex-row rounded-2xl">
					...
					<div className="flex flex-col justify-center p-4 md:w-1/2">
						...
						<div className="py-4">
							...
							<input
								type="text"
								className="w-full p-2 px-4 rounded-md sign-field placeholder:font-light placeholder:text-gray-500"
								name="email"
								id="email"
								placeholder="Email"
								onChange={handleInputChange}
