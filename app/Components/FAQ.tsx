...
const FAQ = () => {
	const faqData = [
		{
			question:
				"How does GreenRecycle help me find e-waste recycling facilities?",
			answer:
				"GreenRecycle's intelligent facility locator uses geolocation technology to instantly identify certified e-waste recycling centers nearest to you. Simply access our interactive map interface, enter your location, and discover detailed information about each facility including operational hours, accepted materials, certification status, and user ratings—all designed to make responsible e-waste disposal effortless and convenient.",
		},
		{
			question:
				"How does GreenRecycle verify the facilities listed on the platform?",
			answer:
		...
		{
			question:
				"What additional benefits do I get by subscribing to the GreenRecycle newsletter?",
			answer:
				...
				<Row>
					<Col>
						...
						<p className="text-center text-gray-600 mb-8">
							Everything you need to know about GreenRecycle and responsible
							e-waste management
						</p>
						<div className="mt-8">
